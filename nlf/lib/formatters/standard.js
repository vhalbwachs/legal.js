...
var isQuestionableDependency = require('../../../isQuestionableDependency');
...
function render(licenseData, callback) {
    ...
    if (isQuestionableDependency(moduleNode)) {
      output.push(archy(moduleNode));
    }
	});
